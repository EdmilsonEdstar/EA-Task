  ...
  return (
    <>
        <div className="h-[100vh] flex flex-col justify-center items-center text-center gap-2 px-2">
            <div className="mb-2">
              <img src="/home4.svg" className="w-100" alt=""/>
            </div>
            ...
            <Link href="" className="px-6 bg-amber-500 text-white font-bold py-2 rounded cursor-pointer hover:bg-amber-600 transition"> {"LET'S START"}</Link>
        </div>
    </>
  );
}
